namespace ADDC.Integration.Common.CRM.Schemas {
    ...
    public sealed class OrganizationService_schemas_microsoft_com_2003_10_Serialization : Microsoft.XLANGs.BaseTypes.SchemaBase {
  ...
  <xs:simpleType name=""guid"">
    <xs:restriction base=""xs:string"">
      <xs:pattern value=""[\da-fA-F]{8}-[\da-fA-F]{4}-[\da-fA-F]{4}-[\da-fA-F]{4}-[\da-fA-F]{12}"" />
        ...
        public OrganizationService_schemas_microsoft_com_2003_10_Serialization() {
        }
